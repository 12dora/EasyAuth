export const zhCN = {
  ...
  "portal.request.baseGrantLockedToApp": "该应用已有授权，本次将作为变更申请提交。",
  ...
  "portal.request.departmentSourced": "来自组织授权",
  "portal.request.departmentSourcedHint": "由组织授权自动获得，无需申请",
  "portal.request.departmentSourcedLoading": "正在读取组织授权…",
  ...
  "portal.approvals.column.requestType": "类型",
...
export const en: Record<keyof typeof zhCN, string> = {
  ...
  "portal.request.baseGrantLockedToApp": "This application already has access; the request is submitted as a change.",
  ...
  "portal.request.departmentSourced": "From organization grants",
  "portal.request.departmentSourcedHint": "Granted automatically by organization policy. No request needed.",
  "portal.request.departmentSourcedLoading": "Loading organization grants…",
  ...
  "portal.approvals.column.requestType": "Type",
