export const zhCN = {
  ...
  "app.alias.hint": "选填。留空则界面上只显示技术名。",
  "app.alias.placeholder": "面向员工的显示名，例如 海关数据",
...
export const en: Record<keyof typeof zhCN, string> = {
  ...
  "app.alias.hint": "Optional. Leave empty to show only the technical name.",
  "app.alias.placeholder": "Employee-facing display name, e.g. Customs Data",
