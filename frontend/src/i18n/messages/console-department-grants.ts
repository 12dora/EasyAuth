export const zhCN = {
  ...
  "departmentGrants.content.moreLabel": "查看其余 {count} 项",
  "departmentGrants.content.empty": "未选择授权组或权限",
...
export const en: Record<keyof typeof zhCN, string> = {
  ...
  "departmentGrants.column.content": "Authorization groups",
  ...
  "departmentGrants.content.empty": "No authorization groups or permissions selected",
