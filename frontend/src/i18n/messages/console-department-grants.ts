export const zhCN = {
  ...
  "departmentGrants.column.content": "授权组",
  ...
  "departmentGrants.content.moreLabel": "查看其余 {count} 个授权组",
  "departmentGrants.content.empty": "未选择授权组",
...
export const en: Record<keyof typeof zhCN, string> = {
  ...
  "departmentGrants.column.content": "Grant groups",
  ...
  "departmentGrants.content.more": "+{count}",
  "departmentGrants.content.moreLabel": "Show the other {count} grant groups",
  "departmentGrants.content.empty": "No grant groups selected",
