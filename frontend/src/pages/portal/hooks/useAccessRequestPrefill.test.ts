...
function catalog() {
  return {
    ...
    authorization_groups: [{ id: 11, app_key: "crm", key: "reader", kind: "role", name: "只读", requestable: true }],
    permission_groups: [],
    ...
    data: [
      {
        ...
        grants: [
          { permission: "customer.read", scope: "SELF", source_type: "direct", source_key: null },
          { permission: "customer.write", scope: "SELF", source_type: "group", source_key: "reader" },
        ],
      },
    ],
