    ...
    <PanelSurface>
      <div className="flex flex-col gap-5" aria-busy={form.isSubmitting || undefined}>
        ...
        <RequestTargetPicker
          ...
          lockedAuthorizationGroupKeys={form.lockedAuthorizationGroupKeys}
          lockedKeys={form.lockedSelectionKeys}
          lockedHint={t("selector.scope.lockedByOrganizationEmployee")}
          departmentSourcedGrant={form.departmentSourcedGrant}
          departmentSourcedStatus={form.departmentSourcedStatus}
          departmentSourcedFetching={form.departmentSourcedFetching}
