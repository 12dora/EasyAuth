...
import type { HandoverBlockedAppsPayload, OperationRow as DomainOperationRow } from "../../lib/domain";
...
function BlockedAppsOperationsSection({ config }: { config: { titleKey: MessageKey; endpoint: string } }) {
  const { t } = useI18n();
