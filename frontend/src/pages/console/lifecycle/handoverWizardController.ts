...
export type HandoverWizardStepId = "apps" | "receivers" | "grants" | "preview" | "execute";
...
export const HANDOVER_WIZARD_STEPS: HandoverWizardStep[] = [
  ...
  { id: "receivers", labelKey: "handover.wizard.step.receivers" },
  { id: "grants", labelKey: "handover.wizard.step.grants" },
  { id: "preview", labelKey: "handover.wizard.step.preview" },
...
const STEP_INDEX = new Map(
  HANDOVER_WIZARD_STEPS.map((step, index) => [step.id, index] as const),
);
