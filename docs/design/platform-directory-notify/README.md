...
当前对外契约以 `docs/api/easyauth-public-api.md`、本目录 01~07 与 09 为准。
08 是已完成实施期的历史 agent 任务卡，仅供追溯，禁止按其中路径、版本或配置口径实施当前接入。
...
| 8 | [08-实施执行顺序-给实施agent.md](08-实施执行顺序-给实施agent.md) | **历史实施任务卡，禁止按当前契约执行**；仅用于追溯当时的 PR 切分与工作流 |
| 9 | [09-实施偏差记录.md](09-实施偏差记录.md) | 实施裁决、收敛提交与当前口径的可追溯记录 |
