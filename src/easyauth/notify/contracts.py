...
NOTIFY_RECONCILE_MAX_ATTEMPTS: Final = 8
# 第 n 次尝试之后的退避取下标 n-1; 8 次总和落在 24h 窗口内。
NOTIFY_RECONCILE_BACKOFF_SECONDS: Final = (60, 120, 300, 900, 1800, 3600, 10800, 21600)
NOTIFY_RECONCILE_CAP_REACHED_MESSAGE: Final = "钉钉回执对账已达上限, 停止轮询, 送达状态未确认。"
