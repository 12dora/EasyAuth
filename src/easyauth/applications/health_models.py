...
DEPENDENCY_DINGTALK_NOTIFY: Final = "dingtalk_notify"
DEPENDENCY_CELERY: Final = "celery"
DEPENDENCY_CONNECTORS: Final = "connectors"
...
DEPENDENCY_HEALTH_DEPENDENCY_CHOICES: Final[tuple[tuple[str, str], ...]] = (
    ...
    (DEPENDENCY_DINGTALK_NOTIFY, "dingtalk_notify"),
    (DEPENDENCY_CELERY, "celery"),
    (DEPENDENCY_CONNECTORS, "connectors"),
)
