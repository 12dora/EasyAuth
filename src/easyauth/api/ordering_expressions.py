...
from django.db.models import CharField, Count, DateTimeField, Exists, Min, OuterRef, Subquery
...
def direct_permission_count():
    return Count("grant_permissions", distinct=True)


def grant_expiration():
    def minimum(model):
        return Subquery(
