...
def backfill_dingtalk_user_name_pinyin(apps, _schema_editor):
    user_model = apps.get_model("accounts", "DingTalkUserMirror")
    batch = []
...
class Migration(migrations.Migration):
    dependencies = [
        ("accounts", "0020_usermirror_avatar_url_textfield"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(backfill_dingtalk_user_name_pinyin, migrations.RunPython.noop),
    ]
